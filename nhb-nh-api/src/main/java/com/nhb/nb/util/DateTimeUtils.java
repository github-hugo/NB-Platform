/** 
 * Project Name:mbox-modules-biz 
 * File Name:DateTimeUtils.java 
 * Package Name:com.movitech.mbox.common.utils 
 * Date:Mar 28, 20172:18:04 PM 
 * Copyright (c) 2017, lorisun@live.com All Rights Reserved. 
 * 
*/

package com.nhb.nb.util;
...
public class DateTimeUtils extends DateUtils {
	 ...
	 * @since JDK 1.8
	 */
	public static Map<String, String> getLastBeforeDateRange() {
		String bTime = StringUtils.EMPTY;
		String eTime = StringUtils.EMPTY;
		Calendar cal = Calendar.getInstance();
