package com.nhb.nb.controller.rate;
...
import com.nhb.nb.dataaccess.service.rate.UnitRateService;
...
public class UnitRateController {
	...
	public RestResultDto save(@RequestBody UnitRate request) {
		...
		try {
			...
			// 列表
			List<UnitRate> rates = unitRateService.findByAreaIdAndStartDateLessThanAndEndDateGreaterThan(areaId, today,
					today, sort);
			UnitRate rate = null;
